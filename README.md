...
The script refreshes, enables, and immediately starts both timers. It also enables and
restarts `jura-server-guard.service` when the panel unit is installed.
