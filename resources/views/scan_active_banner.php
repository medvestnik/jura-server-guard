...
<div class="scan-banner <?= $stale?'scan-stale':'scan-running' ?>">
  ...
  <div class="scan-grid">
    ...
    <span><b><?= e(t('Files scanned:')) ?></b> <?= e($files) ?></span><span><b><?= e(t('Estimated total files:')) ?></b> <?= e($total ?: t('unknown')) ?><?php if($total && ($run['scan_mode']??null)==='changed_only'): ?> <span class="muted small">(<?= e(t('from last run')) ?>)</span><?php endif ?></span><span><b><?= e(t('Progress:')) ?></b> <?= e($pct !== null ? $pct.'%' : t('unknown')) ?></span><span><b><?= e(t('Skipped media:')) ?></b> <?= e($run['skipped_media']??0) ?></span>
